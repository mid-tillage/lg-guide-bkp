...
# question = "How fast are cheetahs?"
# result_3 = chain_3.invoke(question)
# print("Question: " + question)
# print("Answer:" + str(result_3))

# NOTE: it seems LangChain dependencies are being updated right now, installing dependency langchain-anthropic informs deprecated functions are being used.